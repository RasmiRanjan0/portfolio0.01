...
export const HERO_CONTENT = {
  ...
  introduction:
    "I’m Rasmi Ranjan, a creative frontend developer, crafting immersive and intuitive web experiences.",
  description:
...
export const PROJECTS = [
  ...
  },
  {
    ...
    image: projects2,
    link: "https://www.figma.com/proto/WBhEgCFtNYPzHqVkjnTq0X/Portfolio-Web-Design-(Community)?page-id=1%3A1109&node-id=1-1170&viewport=566%2C97%2C0.2&t=ZNBNBh0ijdjSBefJ-1&scaling=min-zoom&content-scaling=fixed",
  },
  {
    name: "HairRevive",
...
export const EXPERIENCES = [
  {
    yearRange: "2024 — Now",
    title: "Senior Frontend Engineer at DevAffairs",
    location: "Remote",
    description: [
...
export const CONTACT_CONTENT = {
  ...
  footerText: `© ${new Date().getFullYear()} Rasmi R. All rights reserved.`,
};
